            ...
            {filteredMappings.length === 0 ? (
              ...
              <div className="space-y-2">
                {filteredMappings.map(([address, mapping]) => (
                  <div key={address} className="group flex justify-around cursor-pointer items-center gap-4 p-4 min-h-[72px] justify-between bg-neutral-800/60 hover:bg-neutral-800 transition-colors duration-150 rounded-lg">
                      ...
                      <div className="flex flex-col grow">
                        <div className="flex items-center gap-2">
                          ...
                          <button 
                              ...
                              className="flex items-center justify-center h-6 w-6 rounded-lg text-gray-400 hover:bg-neutral-700 hover:text-white transition-colors" 
                    ...
                    <div className="flex flex-col shrink-0 items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
